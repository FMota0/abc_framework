    ...
    >
      <g id="graphic" transform="matrix(0.830078,0,0,0.830078,333.5,70)">
          ...
          <g
            ...
            onMouseOver={() => setHovering(StrategyTypes.FieldExperiments)}
          ...
          <g 
            ...
            onMouseOver={() => setHovering(StrategyTypes.ExperimentalSimulations)}
            onMouseLeave={() => setHovering(null)}
            onClick={() => {
          ...
          <g
            ...
            onMouseOver={() => setHovering(StrategyTypes.LaboratoryExperiments)}
            onMouseLeave={() => setHovering(null)}
            onClick={() => {
          ...
          <g
            ...
            onMouseOver={() => setHovering(StrategyTypes.JudgmentStudies)}
            onMouseLeave={() => setHovering(null)}
            onClick={() => {
          ...
          <g
            ...
            onMouseOver={() => setHovering(StrategyTypes.SampleStudies)}
            onMouseLeave={() => setHovering(null)}
            onClick={() => {
          ...
          <g
            ...
            onMouseOver={() => setHovering(StrategyTypes.FormalTheory)}
            onMouseLeave={() => setHovering(null)}
            onClick={() => {
          ...
          <g
            ...
            onMouseOver={() => setHovering(StrategyTypes.ComputerSimulations)}
            onMouseLeave={() => setHovering(null)}
            onClick={() => {
          ...
          <g
            ...
            onMouseOver={() => setHovering(StrategyTypes.FieldStudy)}
            onMouseLeave={() => setHovering(null)}
            onClick={() => {
